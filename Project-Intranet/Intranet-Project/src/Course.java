...
public class Course implements Serializable, Cloneable, Comparable {
	...
	private HashMap<Course, HashMap<Teacher, Student> > cts = new HashMap<Course, HashMap<Teacher, Student> >();
	private HashMap<Course, HashMap<Student, Teacher> > cst = new HashMap<Course, HashMap<Student, Teacher> >();
	public Course() {
